                        ...
                        <div class="card card-details">
                            ...
                            <div class="attendee">
                                <table class="table table-responsive-sm text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6" class="tex-center">No Visitor</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="POST"
                                    ...
                                    <input type="text" name="nationality" required class="form-control mb-2 mr-sm-2" style="width: 50px" id="nationality"
