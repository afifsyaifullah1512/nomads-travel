                                ...
                                <div class="gallery">
                                    <div class="xzoom-container">
                                        <img src="{{ Storage::url($item->galleries->first()->image) }}" class="xzoom"
                                            id="xzoom-default"
                                            xoriginal="{{ Storage::url($item->galleries->first()->image) }}                           </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <div class="members my-2">
                                <img src="{{ url('frontend/images/member-1.jpg') }}" class="members-images mr-1">
                                <img src="{{ url('frontend/images/member-2.jpg') }}" class="members-images mr-1">
                                <img src="{{ url('frontend/images/member-3.jpg') }}" class="members-images mr-1">
                                <img src="{{ url('frontend/images/member-4.jpg') }}" class="members-images mr-1">
                                <img src="{{ url('frontend/images/member-5.jpg') }}" class="members-images mr-1">
                            </div>
                            <hr>
                            ...
                            <table class="trip-information">
                                <tr>
                                    ...
                                    <td width="50%" class="text-right">
                                        {{ \Carbon\Carbon::create($item->departure_date)->format('jS F Y') }}</td>
                                </tr>
                                <tr>
